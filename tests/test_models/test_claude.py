...
class TestClaude:
    def test_init_instructions(self, claude: Claude):
        ...
        expect(claude.page.locator('[data-testid="user-message"]').last).to_have_text(
            re.compile(template, re.IGNORECASE)
        )
    ...
    def test_attach_file(self, claude: Claude, content_file):
        ...
        expect(claude.page.locator("input[type='file']")).to_have_value(
    ...
    def test_text_as_file(self, claude: Claude):
        ...
        expect(claude.page.locator("input[type='file']")).to_have_value(re.compile(r".*attachment.txt", re.IGNORECASE))
